...
describe('UnorderedList', () => {
  ...
  let blockBinding = require('app/mockBackEndResponse/potentialife-course_cycle-1_module-1_step-9.json').blocks[2];
  ...
  describe('View', () => {
    ...
    beforeEach(() => {
      ...
      template = $compile('<unordered-list block="block"></unordered-list>')(scope);
      scope.$apply();
    });
